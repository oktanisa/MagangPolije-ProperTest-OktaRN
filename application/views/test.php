...
<body>
    <div class="well">
        <button type="button" id="btn-tambah" data-toggle="modal" data-target="#form-modal" class="btn btn-warning pull-right">
            <span class="glyphicon glyphicon-plus"></span> &nbsp;Refresh
        </button>
        <button style="margin-right: 20px;" type="button" id="btn-tambah" data-toggle="modal" data-target="#form-modal" class="btn btn-success pull-right">
    ...
    <div id="view" style="margin: 10px 20px;">
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                ?>
                    <tr>
                        <td class="align-middle text-center"><?php echo $start++; ?></td>
                        <td class="align-middle text-center"><?php echo $value->id; ?></td>
                        <td class="align-middle text-center"><?php echo $value->employee_name; ?></td>
                        <td class="align-middle text-center"><?php echo $value->employee_salary; ?></td>
                        <td class="align-middle text-center"><?php echo $value->employee_age; ?></td>
                        <td class="align-middle text-center"><?php echo $value->profile_image; ?></td>
